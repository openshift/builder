...
require (
	...
	github.com/containers/buildah v1.16.7
...
replace (
	...
	// needed to force a newer containers/image than we'd pull in via buildah, to get its #1089 and #1138
	github.com/containers/image/v5 => github.com/containers/image/v5 v5.10.4
